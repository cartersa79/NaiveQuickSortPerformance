...
public class NaiveQuickSortPerformance {
    ...
    public static void main(String[] args) {
        ...
        runFullExperiment("NaiveQuickSort-Exp1-ThrowAway.txt");
    ...
    // This is a "naive" quick sort algorithm. Instead of randomly
    // selecting a pivot, we just choose the first element as the pivot.
    // This is not ideal if you input an already sorted array!
